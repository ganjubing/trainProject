<template>
  <div class="addition">
    <div class="calc" style="">
      <div style="width: 75%;height: 18.8%;margin: 16.5% 11% 3% 11%;">
        <span style="font-size:70px;font-weight: bolder;float: right;margin-right:2%;">{{result}}</span>
      </div>
      <div style="width: 75.5%;height: 56.5%;margin: 0% 10.5%;">
        <div style="width: 100%;height: 50%;">
          <div style="width:75%;height: 100%;float: left;">
            ...
            <div @click="inputNumber(4)" style="width: 31%;height: 45%;float: left;margin:4.5% 3.5% 0% 0%">
              <img src="../../../assets/addition/num4.png" style="height: 100%;width: 100%;" />
            </div>
            <div @click="inputNumber(5)" style="width: 31%;height: 45%; solid;float: left;margin:4.5% 3.5% 0 0">
              <img src="../../../assets/addition/num5.png" style="height: 100%;width: 100%;" />
            </div>
            <div @click="inputNumber(6)" style="width: 31%;height: 45%; solid;float: left;margin-top: 4.5%">
        ...
        <div style="width:100%;height:49%;margin-top:1.6% ;">
          <div style="width:75%;height: 100%;float: left;z-index: 9999;">
            ...
            <div @click="inputNumber(0)" style="width:82%;height: 45%;float: left;margin:4.5% 3.5% 0% 0%">
