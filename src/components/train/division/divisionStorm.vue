  ...
  export default {
    ...
    methods: {
      ...
      createBoat() {
        ...
        divSmash.className = "diviboatSmash";
        ...
        var boatH = document.getElementsByClassName("diviboat")[0].offsetHeight;
      ...
      removeBoat(){
        var boats=document.querySelector(".diviboat");
      ...
      checkItem() {
        ...
        var isCorrect = this.currentResult===this.result;
...
<style>
  .division {
    ...
    /* position: fixed; */
    position: relative;
    background-image: url(../../../assets/division/bg.jpg);
  ...
  .divisioncalc {
    ...
    right: 6%;
    bottom: 22%;
    background-image: url(../../../assets/division/calculator.png);
    background-repeat: no-repeat;
    background-size: 100% 100%;
  }
  ...
  .diviboat {
    ...
    width: 5%;
    height: 11%;
    background-image: url(../../../assets/division/balloon.png);
  ...
  .diviboatSmash {
    ...
    height: 5%;
    margin-top: 60%;
    background-image: url(../../../assets/division/boatSmash1.png);
    background-size: cover;
  }
  ...
  .divResult {
    ...
    top: 0px;
    left: 0px;
    background-image: url(../../../assets/division/result.png);
    background-repeat: no-repeat;
    background-size: cover;
