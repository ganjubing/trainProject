<template>
  <div class="stroopCaption">
    ...
    <div v-show="!isStep1" style="width: 100%;height: 100%;">
      <img src="../../../assets/stroop/step2.png" style="width: 100%;height: 100%;" />
    ...
    <img src="../../../assets/btnStart.png" style="position: absolute;right: 4%;bottom: 5%;" @click="$router.push({name:'ColorStroop'})" />
  </div>
</template>
...
<style>
  .stroopCaption {
    ...
    height: 100%;
    position: absolute;
    background-image: url(../../../assets/stroop/captionbg.png);
