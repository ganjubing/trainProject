<template>
  <div class="words">
    ...
    <div v-if="isStart===false" style="position: absolute;left: 28%;bottom:5%;width:40%;height:20%;">
      <div><img src="@/assets/words/tip.png" style="width: 60%;height: 60%;" /></div>
      <div style="margin-top: 4%;width: 100%;height: 50%;">
        <img @click="nexStep" src="@/assets/words/start.png" style="width: 30%;height:90%;" />
        </div>
    </div>
    <div v-else style="position: absolute;left: 20%;bottom:5%;width:60%;height:20%;">
      <div><img src="@/assets/words/currentTip.png" style="width: 50%;height: 50%;" /></div>
...
<script>
  import equalImg from '../../../assets/words/identical.png';
  import equalHoverImg from '../../../assets/words/identicalHover.png';
  import unequalImg from '../../../assets/words/different.png';
  import unequalHoverImg from '../../../assets/words/differentHover.png';
  import {
    randonArr,
    randomLimit,
    getRandomArr,
  ...
  export default {
    data() {
      return {
        ...
        itemArray:[{name:'east',img:require("@/assets/words/0.png")},
        {name:'south',img:require("@/assets/words/1.png")},
        {name:'west',img:require("@/assets/words/2.png")},
        {name:'north',img:require("@/assets/words/3.png")},],
...
<style scoped="scoped">
  .words {
    ...
    height: 100%;
    position: fixed;
    background-image: url(../../../assets/words/bg.jpg);
  ...
  .divResult {
    ...
    top: 0px;
    left: 0px;
    background-image: url(../../../assets/words/result.png);
    background-repeat: no-repeat;
  ...
  .correctbg{
    ...
    top: 0px;
    left: 0px;
    background-image: url(../../../assets/words/correctbg.png);
    background-repeat: no-repeat;
    background-size: 100% 100%;
   /* background-position: center, center; */
    /* z-index: 9999; */
  ...
  .incorrectbg{
    ...
    top: 0px;
    left: 0px;
    background-image: url(../../../assets/words/inCorrectbg.png);
    background-repeat: no-repeat;
    background-size: 100% 100%;
   /* background-position: center, center; */
    /* z-index: 9999; */
